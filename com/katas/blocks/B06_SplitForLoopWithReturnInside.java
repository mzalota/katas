 ...
 *   5a) Select checkbox "Replace all occurrences".
 * 6) Refactor: "Extract Method". Select for loop and all lines above it in extractIndividualLogicOutOfForLoop() method.
 *   6a) Name new record: Result
 *   6b) Name of new variable: "resultCombo"
 *   6c) Name new method: getResult()
 *
 ...
 * A5) Refactor: "Inline Variable": resultCombo. Place cursor on resultCombo in isMatchWasFound() method
 ...
 * A11) Intention: 'Collapse loop with stream 'anyMatch()'. Place the cursor on the for keyword in method isMatchWasFound().
 *
 ...
 * B10) Intention: 'Collapse loop with stream 'count()'. Place the cursor on the for keyword in method getMatchAtElementIndex().
 *
