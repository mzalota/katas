 ...
 *  3a) Write List<E> as variable type
 ...
 * 6) Intention: Change type of 'result' to List<Object>. Place the cursor on the "List" type declaration of the "List result =" variable.
 * 7) Manually replace change typ of list from "List<Object>" to List<String>
 * 8) Manually write "result" below the end of the for loop.
 ...
 * 11) Intention: Remove redundant initializer. Place the cursor on "null" term.
 * 12) Intention: Join declaration and assignment. Place the cursor on result variable declaration.
