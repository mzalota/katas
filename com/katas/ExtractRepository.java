...
9) Try to merge jdbc connection string in lookupPackagePriceInDB with field jdbcConnection
   ...
   9c) Check "Replace all occurences (2)" box. Notice that the other occurence was found and is, actually, identical!
   9d) Name new field with some temporary name, like "jdbcConnectionTemp"
   9e) Refactor: "Inline Field", the origingal jdbcConnection, Select "Inline all and remove the field"
